...
public class ApplicationVersionServiceImpl implements ApplicationVersionService {
    ...
    public ApplicationVersionResponseDTO createVersion(Long applicationId, String version, String type) {
        ...
        ApplicationVersion appVersion = ApplicationVersion.builder().application(application).version(version)
...
//    @Override
//    public ApplicationVersion deployNewVersion(Application application, String version, ApplicationType type
//    ) {
//        ApplicationVersion appVersion = ApplicationVersion.builder().application(application).version(version).type(type)
//                .build();
